     ...
     <div class="logo">
        ...
        <div class="menu">
            ...
            <dialog id="links">
                ...
                <div class="linksMenu">
                    <ul>
                        <li><a href="../Demanda-da-Saga-SENAI/index.html"> <img src="FrontEnd/assets/Site assets/homeIcon.png" alt="icone" id="iconesPraMenu"> Inicio</a></li>
                        <li><a href="FrontEnd/paginas/loja.html"> <img src="FrontEnd/assets/Site assets/LojaIcon.png" alt="icone" id="iconesPraMenu"> Loja</a></li>
