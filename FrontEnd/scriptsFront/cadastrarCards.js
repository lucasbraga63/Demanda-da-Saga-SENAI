...
const nomeNovoProduto = document.getElementById('inputNomeProduto')
const descricaoNovoProduto = document.getElementById('inputDescricaoProduto')
const imagemNovoProduto = document.getElementById('inputImagemProduto')
const precoNovoProduto = document.getElementById('inputPrecoProduto')

// aqui voce faz a função de cadastrar um novo produto, depois junta com o create card sacou? Por que ela vai pegar exata,emte as mesmas coisas do card anterior
